  ...
  <div class="wrap">
    <div class="footgrid">
      ...
      <div><h4>Company</h4><ul>
        ...
        <li><a href="/certification.html">K9 Alliance Standard</a></li>
...
home_faq = [
 ...
 ("Are your dogs and handlers certified to a recognized standard?",
  "Every team is developed and evaluated against the K9 Alliance Certification Standard, so your records are defensible in procurement and in court. See the certification page for details."),
...
<section class="hero">
  <div class="wrap">
    ...
    <div class="hero-badges">
      <span><b>K9 Alliance</b> Certification Standard</span>
...
<section class="statband sec tight">
  <div class="wrap"><div class="stats">
    ...
    <div class="stat"><div class="n">100%</div><div class="l">Trained to the K9 Alliance standard</div></div>
  </div></div>
</section>
  ...
  <div class="wrap split">
    <div>
      ...
      <ul class="tick">
        ...
        <li><b>Defensible standard.</b> Every team is evaluated to the K9 Alliance Certification Standard.</li>
        <li><b>Full stack.</b> Train, certify, consult, and place — one accountable source.</li>
      </ul>
...
page("index.html", f"{BIZ} — {TAGLINE}",
     "Operational detection dogs and certified handlers for law enforcement, conservation, and private detection teams. Trained, certified, and placed to the K9 Alliance standard. Proven in the field, not just the yard.",
...
<div class="split">
 <div>
  ...
  <ul class="tick">
   ...
   <li>K9 Alliance certification records — defensible in procurement and court.</li>
   <li>Post-placement support and maintenance training options.</li>
   <li>Program development available if you're building or expanding a unit (see <a href="/consulting.html">Consulting</a>).</li>
  </ul>
...
ag_proof = (proof_card("🎯","Deployment case studies",
            ...
            proof_card("🏛️","Agency references",
              f"Talk to departments who run our teams. {fill('Add reference contacts / logos with permission.')}") +
            proof_card("📜","Certification records",
              "Every team documented to the K9 Alliance standard — the paper trail procurement and courts require."))
ag_faq = [
 ("Will these teams hold up to a court challenge?",
  "That's the point. Teams are trained and certified to the K9 Alliance Certification Standard with documented records, so reliability is demonstrable, not just asserted."),
...
hub("agencies.html","a","For Law Enforcement Agencies",
    ...
    "Finished detection dogs and certified handlers for law enforcement — narcotics, explosives, firearms and more, documented to the K9 Alliance standard. Request a capability brief.",
    "Agencies")
...
<div class="card" style="margin-top:24px;background:var(--wash2)">
  <div class="split" style="gap:24px">
   <div><h3 class="mt0">Not ready to enroll yet?</h3><p class="muted mb0">Get the full syllabus and dates. {fill('Attach downloadable syllabus PDF as a lead magnet.')}</p></div>
   <div style="align-self:center"><a class="btn" href="#apply">Get the syllabus</a></div>
  </div>
</div>
...
"""
tr_proof = (proof_card("✅","Outcomes, not attendance","You leave able to run a reliable team — we train the human end of the leash, hard.") +
            proof_card("🧭","A real career path","Foundation → handler → instructor. Grow with a standard behind you.") +
            proof_card("⭐","Alumni results",f"See where our handlers are working. {fill('Add alumni testimonials / outcomes.')}"))
tr_faq = [
 ...
 ("What certification do I earn?",
  "Certification to the K9 Alliance Standard, documenting your team's reliability to a recognized benchmark."),
]
hub("training.html","g","Handler &amp; Instructor Training",
    ...
    "Handler and instructor certification and foundation scent-detection training. Field-first, outcome-driven, and certified to the K9 Alliance standard. Apply or get the syllabus.",
    "Training")
...
co_proof = (proof_card("🔍","Audit methodology","A structured, standards-based evaluation — not opinions. You get a clear picture and a fix-list.") +
            proof_card("📐","The K9 Alliance standard","We assess and build against a defined benchmark, so improvements are measurable.") +
...
co_faq = [
 ...
 ("Do you help us pass certification / accreditation?",
  f"We build and evaluate to the K9 Alliance standard and prepare teams for defensible certification. {fill('Note any specific accreditations you support.')}"),
 ("Remote or on-site?",
...
dd_faq = [
 ...
 ("What's included with a placement?",
  f"Handler training and certification to the K9 Alliance standard, plus support. {fill('Confirm exactly what each placement includes.')}"),
...
<section class="hero"><div class="wrap">
  ...
  <h1>Operator first. Trainer always.</h1>
  <p class="sub">K9School is the working home of {BIZ} — David Latimer's operational detection practice in Lincoln, Alabama.</p>
</div></section>

<section class="sec"><div class="wrap split">
 <div>
  <div class="eyebrow">David Latimer</div>
  <h2>Built on real deployment.</h2>
  <p class="lead">{fill('David’s background — operational experience, disciplines, years, notable work. 2–3 paragraphs in his voice.')}</p>
  <p>{fill('The origin story: why "proven in the field, not just the yard" is the standard he holds. What he saw fail, and what he built to fix it.')}</p>
  <ul class="tick">
   <li>{fill('Credential / certification')}</li>
   <li>{fill('Notable program, agency, or discipline expertise')}</li>
   <li>Creator/adopter of the K9 Alliance Certification Standard for evaluating teams.</li>
  </ul>
  <a class="btn dark" href="/contact.html">Work with David</a>
 </div>
 <div class="ph" style="min-height:320px">Portrait / working photo of David Latimer<br>{fill('add photo')}</div>
</div></section>

<section class="sec wash"><div class="wrap">
  <div class="center"><div class="eyebrow">One operation, several roots</div><h2>K9School, Latimer School, and Kip K9</h2></div>
  <p class="lead center" style="max-width:70ch;margin:16px auto 0">K9School.net is now the single home for the work formerly carried under <b>Kip K9</b> and the <b>Latimer School of Operational K9s</b>. Same operation, same standard, one place to find it — with the legacy detection specialties (narcotics, arson, termite, bed bug, allergen) now organized under our detection-dog service lines.</p>
</div></section>
...
person_schema = ('{"@context":"https://schema.org","@type":"Person","name":"David Latimer",'
  f'"jobTitle":"Founder & Master Detection Dog Trainer","worksFor":{{"@type":"Organization","name":"{BIZ}"}},'
  f'"url":"{SITE}/about.html","knowsAbout":["detection dog training","K9 program development","handler certification"]}}')
...
# ============================================================
cert_faq = [
 ("What is the K9 Alliance Certification Standard?",
  f"A defined benchmark for evaluating detection-team reliability. {fill('Describe the standard: what it tests, how it’s scored, who recognizes it.')}"),
 ("Why does the standard matter for agencies?",
  "Documented certification to a recognized standard makes a team's reliability defensible in procurement and in court — it turns 'trust us' into evidence."),
...
<section class="hero"><div class="wrap">
  ...
  <p class="sub">Every dog and handler we build is evaluated against the K9 Alliance Certification Standard — so your records hold up where it counts.</p>
</div></section>
<section class="sec"><div class="wrap split">
 <div>
  <div class="eyebrow">What it covers</div>
  <h2>A defined benchmark, not a vibe.</h2>
  <p class="lead">{fill('Explain the standard in plain terms — the domains it evaluates and why each matters operationally.')}</p>
  <ul class="tick">
   <li>Scent-detection reliability under realistic conditions.</li>
   <li>Handler communication and control.</li>
   <li>Environmental and operational search challenges.</li>
   <li>Documented, repeatable evaluation.</li>
  </ul>
 </div>
...
"""
page("certification.html","K9 Alliance Certification Standard | K9School",
     "The K9 Alliance Certification Standard — how Latimer School of Operational K9s documents detection-team reliability for defensible, court-ready records.",
...
article("resources-become-a-k9-handler.html",
  ...
  faq=[("Do I need experience to start?",
       ...
       ("What certification will I earn?",
        "Certification as a team to the K9 Alliance Standard, documenting your reliability to a recognized benchmark.")])
...
article("resources-starting-a-k9-program.html",
  ...
  faq=[("Can you just audit our existing program?",
       ...
       ("Do you help us reach certification?",
        f"We build and evaluate to the K9 Alliance standard and prepare teams for defensible certification. {fill('Note specific accreditations you support.')}")])
...
pages = ["index.html","agencies.html","training.html","consulting.html",
         "detection-dogs.html","resources.html","proof.html","about.html","certification.html","contact.html",
